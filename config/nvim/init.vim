...
" Get off my lawn
nnoremap <Left> :echoe "Use h fucker"<CR>
nnoremap <Right> :echoe "Use l fucker"<CR>
nnoremap <Up> :echoe "Use k fucker"<CR>
nnoremap <Down> :echoe "Use j fucker"<CR>
